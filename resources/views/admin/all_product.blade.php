      ...
      <table class="table table-striped b-t b-light" id="myTable">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span>{{ number_format($pro->product_price,0,',','.') }} (vnđ)</span></td>
             <td>{{$pro->product_sale}}</td>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn thực sự muốn xóa sản phẩm ?')" href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active" ui-toggle-class="">
