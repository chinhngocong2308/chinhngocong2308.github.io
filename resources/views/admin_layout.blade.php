    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{asset('public/backend/images/chỉ mục.jpg')}}">
                <span class="username">
                    <?php
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Mục bán sản phẩm</span>
                    </a>
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-brand-product')}}">Thêm mục bán </a></li>
                        <li><a href="{{URL::to('/all-brand-product')}}">Liệt mục bán</a></li>
                  ...
                  <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-images-product')}}">Thêm ảnh sản phẩm</a></li>
                        <li><a href="{{URL::to('/all-images-product')}}">Liệt kê ảnh sản phẩm</a></li>
...
<script type="text/javascript">
    ...
    $('.btn-reply-comment').click(function(){
        ...
        $.ajax({
                ...
                success:function(data){
                   $('.reply_comment').val('');
                   $('#notify_comment').html('<span class="text text-alert">Đã trả lời bình luận!</span>');
                }
            });
