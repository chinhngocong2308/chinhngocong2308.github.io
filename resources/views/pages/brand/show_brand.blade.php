...
@section('content')
		...
		<div class="category-banner">
			...
			<img src="{{asset('public/frontend/img/slider/home-1/gvhomepage-eyewear-01-01-img-120720-desk.jpg')}}" style="width: 1920px;height: 270px">
											...
											<div class="col-md-8 col-sm-8 col-xs-12">
												<div class="product-content">
													...
													<div class="actions-e">
														<div class="action-buttons">
															<div class="add-to-cart">
																<a href="{{URL::to('/chi-tiet-san-pham/'.$product->product_id)}}">Chi tiết</a>
															</div>
															<div class="add-to-links">
																<div class="add-to-wishlist">
