...
class ShopController extends Controller
{
	public function index(Request $request){
     ...
     //    ->orderby('tbl_product.product_id','desc')->get();
        ...
        return view('pages.shop')->with('category',$cate_product)->with('brand',$brand_product)->with('all_product',$all_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('category_post',$category_post);
    }
}
